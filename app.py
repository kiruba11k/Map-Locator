...
POI_CATEGORIES = {
  ...
  "Business": [
    ...
    "healthcare company",
    "diagnostic center corporate office",
...
def load_branch_data() -> pd.DataFrame:
    return pd.DataFrame({
        ...
        "Country": ["India"] * 6,
        "Latitude": [12.9382107, 12.9188658, 12.9246927, 12.9534312, 12.9927608,12.982876],
        "Longitude": [77.6992385, 77.6700914, 77.672937, 77.6406167, 77.7021471, 77.7519497],
    })
...
def create_poi_map(branch_data: pd.DataFrame, poi_data: pd.DataFrame, radius_km: float = 3) -> pdk.Deck:
    ...
    if radius_layer_data:
        layers.append(pdk.Layer(
            "PolygonLayer", radius_layer_data, stroked=True, filled=True,
